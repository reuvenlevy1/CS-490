...
<form method="POST" name="check" action="maketest.php" onsubmit="return submitForm(this);">
  <table id="myTable">
    ...
    <tr>
      <th><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search.." title="Type in a name"></th>
      <th><input type="text" id="myInput1" onkeyup="difficult()" placeholder="Difficulty" title="Type in a name"></th>
      <th><input type="text" id="myInput2" onkeyup="topic()" placeholder="Topic" title="Type in a name">
